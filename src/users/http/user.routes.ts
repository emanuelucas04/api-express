...
usersRouter.post(
  ...
  (request, response) => {
    return createAccessAndRefreshTokenController.handler(request, response)
  },
)
...
usersRouter.put(
  ...
  (request, response) => {
    return updateProfileController.handler(request, response)
  },
)

usersRouter.get('/profile', isAuthenticated, (request, response) => {
  return showProfileController.handler(request, response)
})
